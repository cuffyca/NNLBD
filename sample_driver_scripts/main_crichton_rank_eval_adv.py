...
def Main():
    ...
    model = LBD( print_debug_log = False, network_model = "cd2" )
    ...
    eval_input_1, eval_input_2, eval_input_3, _       = model.Encode_Model_Data( model_type = "closed_discovery", use_csr_format = True, is_crichton_format = True )
