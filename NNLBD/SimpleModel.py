...
class SimpleModel( BaseModel.BaseModel ):
    ...
    def Build_Model( self, number_of_features, number_of_train_1_inputs, number_of_train_2_inputs, number_of_train_3_inputs, number_of_hidden_dimensions, number_of_outputs,
        ...
        if sparse_mode:
            ...
            if self.feature_scale_value != 1.0:
                ...
                tertiary_flatten_layer  = Lambda( lambda x: x * self.feature_scale_value )( tertiary_flatten_layer  )
        ...
        if self.final_layer_type in ["cosface", "arcface", "sphereface"]:
            self.model = Model( inputs = [primary_input_layer, secondary_input_layer, tertiary_input_layer, cosface_input_layer], output = output_layer, name = self.network_model + " model" )
        else:
            self.model = Model( inputs = [primary_input_layer, secondary_input_layer, tertiary_input_layer], output = output_layer, name = self.network_model + " model" )
