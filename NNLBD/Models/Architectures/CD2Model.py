...
if not Utils().Check_For_Installed_Modules( ["numpy", "tensorflow"] ):
    print( "CD2Model - Error: One Or More Required Modules Not Installed" )
    exit()
...
class CD2Model( BaseModel ):
    def __init__( self, print_debug_log = False, write_log_to_file = False, network_model = "cd2", model_type = "open_discovery",
                  ...
                  final_layer_type = "dense", feature_scale_value = 1.0, learning_rate_decay = 0.004, model_path = "", weight_decay = 0.0001, margin = 30.0,
                  scale = 0.35, use_cosine_annealing = False, cosine_annealing_min = 1e-6, cosine_annealing_max = 2e-4, bilstm_dimension_size = 64,
                  bilstm_merge_mode = "concat", skip_gpu_init = False ):
