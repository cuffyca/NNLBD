...
class CosFaceModel( BaseModel.BaseModel ):
    ...
    def Build_Model( self, number_of_features, number_of_train_1_inputs, number_of_train_2_inputs, number_of_hidden_dimensions, number_of_outputs,
        ...
        if sparse_mode:
            ...
            if len( embeddings ) > 0:
                primary_embedding_layer   = Embedding( number_of_features, number_of_hidden_dimensions, input_length = 1, name = 'Primary_Concept_Embedding_Layer', weights = [embeddings], trainable = self.trainable_weights )( primary_input_layer     )
                secondary_embedding_layer = Embedding( number_of_features, number_of_hidden_dimensions, input_length = 1, name = 'Secondary_Concept_Embedding_Layer', weights = [embeddings], trainable = self.trainable_weights )( secondary_input_layer )
            else:
                primary_embedding_layer   = Embedding( number_of_features, number_of_hidden_dimensions, input_length = 1, name = 'Primary_Concept_Embedding_Layer', trainable = self.trainable_weights )( primary_input_layer     )
                secondary_embedding_layer = Embedding( number_of_features, number_of_hidden_dimensions, input_length = 1, name = 'Secondary_Concept_Embedding_Layer', trainable = self.trainable_weights )( secondary_input_layer )
