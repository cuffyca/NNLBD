...
class BaseModel( object ):
    def __init__( self, print_debug_log = False, write_log_to_file = False, network_model = "N/A", model_type = "open_discovery",
        ...
        if self.enable_early_stopping: self.callback_list.append( keras.callbacks.EarlyStopping( monitor = early_stopping_metric_monitor, patience = early_stopping_persistence ) )
