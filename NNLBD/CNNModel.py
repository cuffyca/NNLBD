...
from keras.layers import Dense, Activation, Input, Dropout, Embedding, Flatten, BatchNormalization, Conv1D, MaxPooling1D, Lambda
...
class CNNModel( BaseModel.BaseModel ):
